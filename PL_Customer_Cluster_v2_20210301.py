...
def date(dates, id_unit_usaha):
    ...
    # print(mlist)
    u = date_list(mlist, id_unit_usaha)
    return u
...
def mass_upload(startDate, endDate, id_unit_usaha):
    ...
    return totalData
    # estTime = run_once(totalData)
    # print(totalData)
    # print(run_once(startime, totalData))
...
if startDate != "" and endDate != "":
    ...
    for i in range(len(id_unit_usaha2)):
        id_unit_usaha = id_unit_usaha2[i]
        totalData = date(dates, id_unit_usaha)
        totalData3 = totalData + totalData3
    print(totalData3)
